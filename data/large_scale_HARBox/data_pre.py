...
def load_data(data_dir, user_id):
	...
	for class_id in range(NUM_OF_CLASS):
		...
		read_path = data_dir + '/' +  str(user_id) + '/' + str(class_set[class_id]) + '_train' + '.txt'
...
# 	print(current_user_id, ":", x_coll.shape, y_coll.shape, dimension, num_of_class)
...
# print('harbox')
# x, y, _, _ = load_data(data_dir = '.', user_id = 1)
# print(x.shape)
